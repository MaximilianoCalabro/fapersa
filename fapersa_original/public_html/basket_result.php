...
?>				
<div id="tabla_gral">
<div id="tabla_titulo" class="titulo_tabla"><div id="code">code</div>
  <div id="measure">quantity</div>
  <div id="measure">measure</div><div id="measure">brand</div><div id="descripcion">description</div></div>
<?
$bgcolor="tabla_1";	
...
?>
  ...
  <div id="catalogo_header"><div id="carrito"><div id="basket_catalogo">Total product: <?=$cantidad_total ?></div></div></div>
...
<?
	...
	?>
  <div id="catalogo_header"><div id="no_result">There are no products in your basket<br><?=$goback?></div></div>
<?
}
?>