...
if ($_GET[envio] == "true") {
	...
	if ($count_result !== "0") {
		...
		$contents_user = "Dear " . $c[nombre] . ":<br><br>";
		$contents_user .= "Below are the ordered products in <a href=\"" . SITE_URL . "\">Fapersa.com</a>";
	...
	$contents .= '		<tr>' . "\n";
	$contents .= '			<td valign="top" width="20%"><b><span class="textonegro">Code</span></b></td>' . "\n";
	$contents .= '			<td width="40%" align="center" valign="top"><b><span class="textonegro">Description</span></b></td>' . "\n";
	$contents .= '			<td width="15%" align="center" valign="top"><b><span class="textonegro">Brand</span></b></td>' . "\n";
	$contents .= '			<td width="15%" align="center" valign="top"><b>Measure</b></td>' . "\n";
	$contents .= '			<td width="10%" align="center" valign="top"><b>Quantity</b></td>' . "\n";
	$contents .= '		</tr>' . "\n";
	...
	$contents .= '		</tr>' . "\n";
	$contents .= '	<tr>' . "\n";
	$contents .= '		<td colspan="4" align="right" valign="top"><b><font color="#FF0000">Total Products</font></b></td>' . "\n";
	...
	$contents .= '</table>' . "\n";
		...
		?>
		<div id="catalogo_header"><div id="no_result">Request sent successfully</div></div>
		<?

	}else{
		?>
		<div id="catalogo_header"><div id="no_result">There are no products in your basket</div></div>
		<?
	}
}else{
	?>
<div id="catalogo_header"><div id="no_result">You are not logged in<br><a href="login.php">login</a></div></div>
<?
}
}
?>
