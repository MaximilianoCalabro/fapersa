...
function tb_show(caption, url, imageGroup) {//function called when the user clicks on a thickbox link
	...
	try {
		if(url.indexOf('TB_transparent') != -1){
			windowClass = 'TB_transparent';
		}else{
			windowClass = 'TB_window';
		}
		...
		if (typeof document.body.style.maxHeight === "undefined") {//if IE 6
			...
			if (document.getElementById("TB_HideSelect") === null) {//iframe to hide select elements in ie6
				$("body").append("<iframe id='TB_HideSelect'></iframe><div id='TB_overlay'></div><div id='TB_window' class='" + windowClass + "'></div>");
				$("#TB_overlay").click(tb_remove);
			}
		}else{//all others
			if(document.getElementById("TB_overlay") === null){
				$("body").append("<div id='TB_overlay'></div><div id='TB_window' class='" + windowClass + "'></div>");
				$("#TB_overlay").click(tb_remove);
			}
		}
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images
			...
			if (!(TB_PrevHTML === "")) {
				function goPrev(){
					...
					$("#TB_window").remove();
					$("body").append("<div id='TB_window' class='" + windowClass + "'></div>");
